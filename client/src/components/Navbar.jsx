...
const Navbar = () => {
    ...
    return (
        <nav className="bg-black text-white h-16 flex items-center justify-between fixed top-0 left-0 w-full z-50">
            ...
            {/* Logo */}
            <div
                className="text-2xl font-extrabold p-5 md:mr-auto cursor-pointer"
            ...
            <div className="flex items-center justify-end flex-grow pr-5">
                {" "}
                {/* Align to right */}
                <div className="options flex-grow md:flex-grow-0 justify-center">
                    ...
                    >
                        <li
                            className="cursor-pointer px-5 py-3 md:px-0 md:py-0 hover:bg-gray-700"
                            onClick={handleHomeClick}
                        >
                            Home
                        </li>
                        <li
                            className="cursor-pointer px-5 py-3 md:px-0 md:py-0 hover:bg-gray-700 relative"
                        ...
                        <li className="cursor-pointer px-5 py-3 md:px-0 md:py-0 hover:bg-gray-700">
                            <a href="/download">ePage</a>
                        </li>
                        <li className="cursor-pointer px-5 py-3 md:px-0 md:py-0 hover:bg-gray-700">
